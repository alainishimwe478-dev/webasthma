// src/pages/Dashboard.jsx - Complete Working Dashboard
      ...
      <div style={styles.weatherCard}>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                color: activeWeatherTab === tab ? "#fff" : "#fff",
              }}
            >
              {tab}
            </button>
        ...
        <div style={styles.weatherContent}>
          {activeWeatherTab === "Temperature" && (
            <div>
              <p>
                🌡️ <strong>Today's Range:</strong> 60°F → 75°F → 65°F
              </p>
              <p>
                📈 <strong>Asthma Risk:</strong> Moderate - High pollen count
              </p>
            </div>
          )}
          {activeWeatherTab === "Precipitation" && (
            <div>
              <p>
                🌧️ <strong>Chance of Rain:</strong> 40%
              </p>
              <p>
          ...
          {activeWeatherTab === "Wind" && (
            <div>
              <p>
                💨 <strong>Wind Speed:</strong> 5 mph (Light breeze)
              </p>
              <p>
                🍃 <strong>Wind Direction:</strong> NE
              </p>
            </div>
          )}
          {activeWeatherTab === "Air Quality" && (
            <div>
              <p>
                🌿 <strong>Air Quality Index:</strong> 42 (Good)
              </p>
              <p>
                ✅ <strong>Safe for outdoor activities</strong>
              </p>
            </div>
          )}
          {activeWeatherTab === "UV Index" && (
            <div>
              <p>
                ☀️ <strong>UV Index:</strong> 3 (Low)
              </p>
              <p>
                🕶️ <strong>Protection needed:</strong> Minimal
              </p>
            </div>
          )}
        </div>
            ...
            <div style={styles.distributionContainer}>
              <div style={styles.distributionItem}>
                <div style={styles.distributionLabel}>
                  ...
                  <span style={styles.distributionPercent}>65%</span>
                </div>
              ...
              <div style={styles.distributionItem}>
                <div style={styles.distributionLabel}>
                  ...
                  <span style={styles.distributionPercent}>25%</span>
                </div>
                <div style={styles.progressBar}>
                  <div
                    style={{
              ...
              <div style={styles.distributionItem}>
                <div style={styles.distributionLabel}>
                  ...
                  <span style={styles.distributionPercent}>8%</span>
                </div>
                <div style={styles.progressBar}>
                  <div
                    style={{
              ...
              <div style={styles.distributionItem}>
                <div style={styles.distributionLabel}>
                  ...
                  <span style={styles.distributionPercent}>2%</span>
                </div>
                <div style={styles.progressBar}>
                  <div
                    style={{
          ...
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={styles.modalBody}>
              <div style={styles.infoGrid}>
                ...
                <div style={styles.infoItem}>
                  <div style={styles.infoLabel}>Peak Flow</div>
                  <div style={styles.infoValue}>
                    {selectedPatient.peakFlow} L/min
                  </div>
                </div>
                <div style={styles.infoItem}>
                  <div style={styles.infoLabel}>Phone</div>
                  <div style={styles.infoValue}>{selectedPatient.phone}</div>
                </div>
                <div style={styles.infoItem}>
              ...
              <div style={styles.medicationsSection}>
                ...
                <div style={styles.medicationsList}>
                  {selectedPatient.medications.map((med, i) => (
                    <span key={i} style={styles.medicationTag}>
                      {med}
                    </span>
                  ))}
                </div>
            ...
            <div style={styles.modalFooter}>
              ...
              <button style={styles.modalButton}>Update Treatment</button>
              <button
